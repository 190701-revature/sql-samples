...
-- % - Is a wildcare of any size
-- _ - A wildcard of a single character length
select * from cats where lower(name) like '%x';

-- Use between to filter where a column is between two values (or dates!)
select * from cats where birthdate 
	between '2008-01-01' and current_timestamp;
